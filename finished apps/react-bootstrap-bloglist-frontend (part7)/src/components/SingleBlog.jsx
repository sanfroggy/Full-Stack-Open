...
const SingleBlog = ({ loggedUser }) => {
    ...
    the blog has any comments and returning them also if it does, as well as a
    ...
    if (blog) {
        return (
            <div>
                ...
                {blog.likes} likes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;
                {blog.likes > 10000 ? <Button variant='warning' id='likeBtn' onClick={handleLikes}>Like</Button>
                    : <Button variant='info' id='likeBtn' onClick={handleLikes}>Like</Button>}
                <br />
                {blog.user && (
                    <div>
                        <br />
