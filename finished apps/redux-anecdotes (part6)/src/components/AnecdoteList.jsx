...
const AnecdoteList = () => {
    ...
    to define a function for voting an anecdote and imported setMessageDisplay
    to display a notification for 5 seconds. */
    const vote = (id) => {
        const anecdote = anecdotes.find(anecdote => anecdote.id === id)
        dispatch(voteForAnecdote(id))       
        dispatch(setMessageDisplay(`Anecdote: "${anecdote.content}" has received a vote.`, 5))
    }
