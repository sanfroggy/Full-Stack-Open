        ...
        describe('and when a blog is already created', function () {
            ...
            it('when there are multiple, the blogs are sorted according to likes', function () {
                ...
                cy.get('@viewButton').click().parent().find('button').contains('Like')
                    .as('likeButton')
                cy.get('@likeButton').click()
                cy.contains('A jedi master am i').parent().contains('Likes:')
                    .parent().should('contain', '1')
                cy.contains('Life of a Sith Lord').parent().contains('View').as('viewButton')
                cy.get('@viewButton').click().parent().find('button').contains('Like')
                    .as('likeButton')
                cy.get('@likeButton').click()
                cy.contains('Life of a Sith Lord').parent().contains('Likes:')
                    .parent().should('contain', '1')
                cy.contains('A jedi master am i').parent().find('button').contains('Like')
                    .as('likeButton')
                cy.get('@likeButton').click()
                cy.contains('A jedi master am i').parent().contains('Likes:')
                    .parent().should('contain', '2')
                ...
                cy.createBlog({
                    ...
                    author: 'BlasterMan109', url: 'http://www.diaryofastormtrooper.com',
                    likes: 3400
                })
