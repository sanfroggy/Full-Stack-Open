...
const App = () => {
    ...
    return (
        <div className={'container'}>
            <div>
                <Navbar collapseOnSelect expand="md" bg="success" variant="success">
                    ...
                    <Nav className="mr-auto">
                        <Nav.Link style={{ position: 'relative', left: "10px" }} href='#' as='span'>
                            <Link style={textStyle} to='/blogs'>Blogs</Link>
                        </Nav.Link>
                        <Nav.Link style={{ position: 'relative', left: "10px" }} href='#' as='span'>
                            <Link style={textStyle} to='/users'>Users</Link>
                        </Nav.Link> &nbsp;&nbsp;&nbsp;
                        {loggedUser ? <><em style={{ position: 'relative', top: '9px', left: "10px" }}>
                            {`Currently logged in as ${loggedUser.name}`}</em>  &nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;<Button size="sm" variant="dark" onClick={() =>
                        { dispatch(resetUser()) }}> Logout</Button></> : <>
            ...
            <br />
            <h1 style={{ fontFamily: 'Segoe Script' }}>Blogs:</h1><Notification /><br /><br /><Routes>
