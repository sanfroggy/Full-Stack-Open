...
/*Using axios.post method to create a new Comment object
related to a Blog object in the MongoDB database through
Node backend and returning the response. */
const createComment = async (blogId, commentObj) => {
...
export default { getAll, setToken, createNew, updateBlog, deleteBlog, createComment }
