//Importing the useDispatch, useState, useEffect and useRef hooks, as well as the necessary components and services.
    ...
    const addBlog = async (newBlog) => {
        try {
            ...
            if (token) {
                ...
                /*Setting the message to be passed on to the store for the
            ...
            /*Setting the errorMessage to be passed on to the
            store for theNotification component, in the case that the new blog is
    ...
    if (!user) {
        ...
        return (
            <div>
                ...
                <br />
                <Blogs blogs={blogs} handleUpdate={addLike} currentUser={user} handleDelete={deleteBlog} />
            </div>
        )
    }
}
