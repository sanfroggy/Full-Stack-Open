...
/*Exporting an action creator for creating a Comment object using async/await and
useDispatch hook to post data to the backend and save it to the store. The id of the
related blog object is also required for the backend requesst url.
If an exception is caught it is shown as a message. The comments array of
a blog is populated in backend so on successful operation the
state of the blogs is updated and the array is sorted. */
