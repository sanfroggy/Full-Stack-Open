...
const CreateNew = (props) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        props.addNew({
            content: content.objectProps.value,
            author: author.objectProps.value,
            info: info.objectProps.value,
            votes: 0
        })
        navigate('/')
    }
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    Content: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name='contentInput' {...content.objectProps } />
                </div>
                <br />
                <div>
          Author: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name='authorInput' { ...author.objectProps } />
                </div>
                <br />
                <div>
           Url for more info: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name='infoInput' { ...info.objectProps } />
                </div>
                <br />
